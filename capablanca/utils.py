...
def reduce_3sat_to_mock_3sat(clauses, max_variable):
    """
    Converts a 3SAT formula to a mock 3SAT instance.

    Args:
        clauses: A list of 3CNF clauses.
        max_variable: The maximum variable in the input formula.

    Returns: A tuple (mock_three_sat_clauses, new_max_variable), where:
            - mock_three_sat_clauses: A list of mock 3SAT clauses.
            - new_max_variable: The maximum variable in the new 3CNF formula.
    """

    mock_three_sat_clauses = []
    ...
    for variable in variables: # Keep consistency between x and ¬x
        ...
        mock_three_sat_clauses.extend([[positive_literal, negative_literal, pivot],
    ...
    for clause in clauses: # Classic reduction from 3SAT to 1-IN-3-3SAT 
        ...
        mock_three_sat_clauses.append([x, y, z])
